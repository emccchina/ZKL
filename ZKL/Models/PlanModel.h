...
@property (nonatomic, assign) long planMinute;// 所需总时间 分钟
@property (nonatomic, assign) long eachMinute;// 每日所需时间(24小时 = eachTime + unableTime + 浪费时间)分钟
@property (nonatomic, assign) long unableMinute;// 每日无法使用的时间(休息时间)分钟
